...
1. **Block SMB from Attacker Subnet**: Deny TCP port 445 from `192.0.2.30` to any internal IP.
2. **Block RDP from Attacker Subnet**: Deny TCP port 3389 from `192.0.2.30` to any internal IP.
